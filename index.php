        ...
        <div id="portfolio-grid" class="row no-gutter" data-aos="fade-up" data-aos-delay="200">
          <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Steak, Brie, and Roasted Cranberry Crostinis</h3>
                <span></span>
              </div>
          ...
          <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Fish Tacos with Cranberry Salsa</h3>
                <span></span>
              </div>
          ...
          <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Herb, Roasted Garlic, and Parm Bread Dipping Oil</h3>
                <span></span>
              </div>
          ...
          <div class="item web col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Wild Blueberry BBQ Wings</h3>
                <span></span>
              </div>
          ...
          <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Parmesan Roasted Potatoes</h3>
                <span></span>
              </div>
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>The Ultimate Homemade Focaccia</h3>
                <span></span>
              </div>
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Za’atar & Olive Oil Sourdough Bagels</h3>
                <span></span>
              </div>
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Cheesy Pull-Apart Garlic Bread</h3>
                <span></span>
              </div>
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Chocolate Fudge Loaf Cake</h3>
                <span></span>
              </div>
          ...
          <div class="item design col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Cinnamon Swirl Banana Bread</h3>
                <span></span>
              </div>
          ...
          <div class="item photography col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Vanilla Bean Cold Brew Latte</h3>
                <span></span>
              </div>
          ...
          <div class="item photography col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Midnight Mocha Cold Brew Latte</h3>
                <span></span>
              </div>
          ...
          <div class="item photography col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Vietnamese Cold Brew Coffee</h3>
                <span></span>
              </div>
          ...
          <div class="item branding col-sm-6 col-md-4 col-lg-4 mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Maple Bacon Sweet Potatoes</h3>
                <span></span>
              </div>
          ...
          <div class="item branding col-sm-6 col-md-4 col-lg-4Grape Salad mb-4">
            <a href="work-single.php" class="item-wrap fancybox">
              <div class="work-info">
                <h3>Green Bean Casserole with Fresh Green Beans</h3>
                <span></span>
              </div>
