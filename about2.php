      ...
      <div class="row align-items-start">
        <div class="col-md-2">
          <ul class="custom-menu">
            ...
            <li class="active"><a href="about2.php">About Me</a></li>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>About Me</h2>
            <p class="mb-0">I am Neil Anthony Prohibido Third Year Student from Laguna State Polytechnic University (Siniloan Campus). Taking a Bachelor of Science in Information Technology major in Web and Mobile Application Development<br>I like Foods</p>
            <br>
            <br>
        ...
        <div class="row">
          <div class="col-md-4 ml-auto order-2" data-aos="fade-up">
            <h3 class="h3 mb-4">Food Ratings</h3>
            ...
            <br>
            <br>
            <p>Edit your Ratings</p>
            <i class="bi bi-pencil-square fs-3"></i>
          </div>

          <div class="col-md-7 mb-5 mb-md-0" data-aos="fade-up">
            <p><img src="assets/img/neil.jpg" alt="Image" class="img-fluid"></p>
          </div>
